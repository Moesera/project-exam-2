    ...
    <div className="flex flex-col justify-center min-h-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5 mx-auto bg-white w-4/7">
        <label className="flex flex-col font-inder">
          Email
          <input className="p-2 border rounded-lg" type="text" value={email} onChange={(event) => setEmail(event.target.value)} required />
        </label>
        <label className="flex flex-col font-inder">
          Password
          <input className="p-2 border rounded-lg" type="password" value={password} onChange={(event) => setPassword(event.target.value)} required />
        </label>
      ...
      <section className="mx-auto mt-20 w-4/7">
        ...
        <button type="button" onClick={ShowRegister} className="flex items-center justify-between w-full px-4 py-2 mt-14 rounded-xl shadow-3xl">
