  ...
  return (
    <>
      ...
      <section className="flex w-3.5/7 items-center">
        <input className="pl-20 h-16.5 border rounded-full border-stone-grey w-full" type="text" placeholder="Search venues" />
      ...
      <nav className="fixed inset-x-0 bottom-0 flex self-center justify-center p-4 border border-stone-300">
        <ul className="flex justify-between m-auto w-4/7">
