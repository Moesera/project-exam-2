      ...
      <div class="mx-auto w-full max-w-[550px]">
        ...
        <form className="font-inder" method="POST">
          <div class="mb-5">
            ...
            <input type="text" name="name" id="name" placeholder="Full Name" class="w-full p-2 border rounded-lg outline-none focus:border-ocean focus:shadow-md" />
          </div>
          <div class="mb-5">
            <label for="email" class="mb-3 block font-medium ">
              Email Address
            </label>
            <input type="email" name="email" id="email" placeholder="example@domain.com" class="w-full p-2 border rounded-lg outline-none focus:border-ocean focus:shadow-md" />
          </div>
          <div class="mb-5">
            <label for="subject" class="mb-3 block font-medium">
              Subject
            </label>
            <input type="text" name="subject" id="subject" placeholder="Enter your subject" class="w-full p-2 border rounded-lg outline-none focus:border-ocean focus:shadow-md" />
          </div>
          <div class="mb-5">
